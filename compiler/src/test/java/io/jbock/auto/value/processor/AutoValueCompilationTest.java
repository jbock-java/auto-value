    ...
    public void correctBuilder() throws IOException {
        ...
        String[] expectedOutput =
                new String[]{
                        ...
                        "",
                        "  @Override",
                        "  public Optional<String> anOptionalString() {",
                        "    return anOptionalString;",
                        "  }",
                        "",
                        "  @Override",
                        "  public NestedAutoValue<T> aNestedAutoValue() {",
                        ...
                        "",
                        "  @Override",
                        "  public Baz.Builder<T> toBuilder() {",
